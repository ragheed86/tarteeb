...
const NAV = [
  ...
  { group: 'العمليات', items: [
    ...
    { href: '/suppliers', label: 'الموردون', icon: IconTruck, sub: 'موردو المواد والمنظمات' },
  ] },
  { group: 'المالية', items: [
    { href: '/invoices', label: 'الفواتير', icon: IconDoc, sub: 'الفواتير والمدفوعات' },
    { href: '/partners', label: 'الشركاء', icon: IconUsers, sub: 'نِسب الشركاء وحساباتهم' },
  ] },
  { group: 'المؤسسة', items: [
    { href: '/government', label: 'الجهات الحكومية', icon: IconGov, sub: 'الرخص والاشتراكات' },
    { href: '/settings', label: 'الإعدادات', icon: IconGear, sub: 'معلومات الشركة' },
  ] },
];
...
function IconTruck() { return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7"><path d="M3 6h11v9H3zM14 9h4l3 3v3h-7z" /><circle cx="7" cy="18" r="1.6" /><circle cx="17.5" cy="18" r="1.6" /></svg>; }
function IconGov() { return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7"><path d="M3 21h18M4 21V10l8-5 8 5v11M9 21v-6h6v6" /></svg>; }
