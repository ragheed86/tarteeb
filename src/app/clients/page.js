...
const RIYADH_DISTRICTS = [
  ...
  'الخزامى', 'الخليج', 'الدار البيضاء', 'الدريهمية', 'الدفاع', 'الدوبية', 'الديرة', 'الرائد', 'الربوة',
  ...
  'الياسمين', 'اليرموك', 'اليمامة', 'أم سليم', 'أم الحمام الشرقي', 'أم الحمام الغربي', 'بدر', 'بنبان', 'ثليم', 'جبرة',
  'جرير', 'حطين', 'خزام', 'خشم العان', 'ديراب', 'سلام', 'سلطانة', 'شبرا', 'صلاح الدين',
